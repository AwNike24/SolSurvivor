    ...
    <div class="container-fluid">
      <div style="width: 100%" class="row justify-content-center">
        <div class="col-12 d-flex d-lg-none justify-content-start mb-4">
          <div class="row px-5">
            <div class="col-12">
              <img class="img-solana-footer" src="/images/Solsurvivor.svg" />
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-12">
          <div class="row px-5">
            <div class="col-12 email-link">hello@solanasurvivor.com</div>
            <div class="col-12 address">© FOURCASTER LIMITADA, 2021</div>
          </div>
        </div>
        <div class="col-3 d-none d-lg-flex align-self-center">
          <img
            class="mx-auto d-block img-solana-footer"
            src="/images/Solsurvivor.svg"
          />
        </div>
        <div class="col-lg-3 col-12 py-3 py-lg-0">
          <div class="row justify-content-center">
            ...
            <div class="col-2">
              <a
                href="https://www.youtube.com/channel/UCGrvRye75ninEA07VB4QpOA"
                target="_blank"
                rel="noopener"
                class="social-link"
              >
                <img
                  src="data:image/svg+xml;base64,"
                  alt="YouTube"
                />
              </a>
            </div>
